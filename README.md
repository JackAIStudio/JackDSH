...
| 平台 | 安装包格式 | 适用说明 | 下载直达 |
| :--- | :--- | :--- | :--- |
| **macOS** | `.dmg` 镜像安装包 | 分为 Apple Silicon (M1/M2/M3/M4) 与老款 Intel 芯片版，双击拖拽安装 | [前往 Releases 下载](../../releases/latest) |
| **Windows** | `.exe` 标准安装包 | 标准安装向导，自动创建桌面与开始菜单快捷方式，适合主力机长期使用 | [前往 Releases 下载](../../releases/latest) |
| **Windows** | `.exe` 免安装便携版 | **双击即用（绿色版）**，不写系统注册表，聊天数据在软件同级目录，支持放 U 盘 | [前往 Releases 下载](../../releases/latest) |
